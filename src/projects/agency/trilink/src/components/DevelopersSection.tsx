    ...
    <section id="developers" className="py-24 bg-slate-950 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-24">
        ...
        <div className="space-y-8">
          ...
          <div className="rounded-3xl bg-slate-900/90 border border-slate-800 p-6 sm:p-10 relative overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10 items-center text-center">
              ...
              <div className="space-y-3">
                <div className="text-xs uppercase font-mono font-bold text-slate-400 mb-2 text-left sm:text-center">
                  Business Systems
                </div>
                {['ERP (NetSuite, SAP)', 'CRM (Salesforce, HubSpot)', 'Subscriptions & Billing', 'Booking Engine'].map(
                  (sys, idx) => (
                    <div
                      key={idx}
                      className="p-3.5 rounded-2xl bg-slate-800/80 border border-slate-700/60 text-xs font-semibold text-slate-200 shadow-sm hover:border-emerald-400/80 transition-colors"
                    >
                      {sys}
                    </div>
                  )
              ...
              <div className="space-y-4">
                <div className="text-xs uppercase font-mono font-bold text-emerald-400 mb-2">
                  Trilink Integration Core
                </div>

                <div className="p-6 rounded-3xl bg-gradient-to-b from-[#0A2333] to-slate-900 border border-emerald-500/40 shadow-2xl space-y-3">
                  <div className="w-12 h-12 mx-auto rounded-2xl bg-[#00E599] text-slate-950 flex items-center justify-center font-black shadow-lg">
                    TL
                  </div>
        ...
        <div className="space-y-8 pt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-8 rounded-3xl bg-slate-900 border border-slate-800 hover:border-emerald-400/60 transition-colors">
              <div className="text-4xl sm:text-5xl font-mono font-extrabold text-amber-400">500M+</div>
              <div className="text-sm font-semibold text-slate-300 mt-2">API requests per day</div>
              <p className="text-xs text-slate-500 mt-1">Processed with zero downtime across 28 global points of presence.</p>
            </div>

            <div className="p-8 rounded-3xl bg-slate-900 border border-slate-800 hover:border-emerald-400/60 transition-colors">
              <div className="text-4xl sm:text-5xl font-mono font-extrabold text-pink-400">10K+</div>
              <div className="text-sm font-semibold text-slate-300 mt-2">API requests per second</div>
              <p className="text-xs text-slate-500 mt-1">Peak bursting capacity engineered for viral launches and flash sales.</p>
            </div>

            <div className="p-8 rounded-3xl bg-slate-900 border border-slate-800 hover:border-emerald-400/60 transition-colors">
              <div className="text-4xl sm:text-5xl font-mono font-extrabold text-emerald-400">150K+</div>
              <div className="text-sm font-semibold text-slate-300 mt-2">transactions per minute</div>
              <p className="text-xs text-slate-500 mt-1">Tested during global high-volume holiday sales.</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8 pt-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-3xl bg-slate-900 border border-slate-800 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="h-44 rounded-2xl bg-slate-950 p-4 border border-slate-800 flex flex-col justify-between text-xs">
                  <div className="space-y-2">
                    <div className="p-2 rounded-lg bg-slate-800 text-slate-300">
                      "I'd like to purchase your organic coffee subscription."
                    </div>
                    <div className="p-2 rounded-lg bg-emerald-950/80 border border-emerald-800 text-emerald-300 flex items-center justify-between">
                      <span>buy.trilink.com/roastery-sub</span>
                      <QrCode className="w-4 h-4 text-emerald-400" />
                    </div>
                  </div>
                  <div className="text-[11px] text-slate-500 flex justify-between">
                    <span>Generated in 1 click</span>
                    <span className="text-emerald-400 font-bold">QR & Link Ready</span>
                  </div>
                </div>
              ...
              <a href="#no-code" className="text-xs font-bold text-[#00E599] flex items-center hover:underline">
            ...
            <div className="p-6 rounded-3xl bg-slate-900 border border-slate-800 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                <div className="h-44 rounded-2xl bg-slate-950 p-4 border border-slate-800 flex items-center justify-center">
                  <div className="grid grid-cols-3 gap-2 w-full text-center">
                    {['Shopify', 'WooCommerce', 'Webflow', 'Squarespace', 'Xero', 'Zapier'].map((p, i) => (
                      <div key={i} className="p-2.5 rounded-xl bg-slate-900 border border-slate-800 text-xs font-semibold text-slate-300 hover:text-white hover:border-emerald-400 transition-colors">
                        {p}
                      </div>
                    ))}
                  </div>
              ...
              <a href="#marketplace" className="text-xs font-bold text-blue-400 flex items-center hover:underline">
            ...
            <div className="p-6 rounded-3xl bg-slate-900 border border-slate-800 flex flex-col justify-between space-y-6">
              <div className="space-y-4">
                ...
                <div className="rounded-2xl bg-black border border-slate-800 overflow-hidden">
                  ...
                  <pre className="p-3 text-[11px] font-mono text-emerald-300 overflow-x-auto max-h-32">
              ...
              <a href="#docs" className="text-xs font-bold text-[#00E599] flex items-center hover:underline">

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5">
            ...
            <button
              ...
              onClick={onOpenRfq}
              className="relative flex items-center gap-1.5 px-2.5 py-1.5 sm:px-3 sm:py-2 text-xs sm:text-sm font-semibold text-[#0b1b33] bg-slate-100 hover:bg-slate-200 rounded-lg transition-all border border-slate-200 shrink-0"
              title="View Request For Quote Basket"
            >
              <ShoppingBag className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#0284c7]" />
              <span className="hidden sm:inline">RFQ Basket</span>
              <motion.span 
                key={rfqCount}
                initial={{ scale: 0.6 }}
                animate={{ scale: 1 }}
                className={`flex items-center justify-center min-w-[18px] h-4 sm:h-5 px-1 text-[10px] sm:text-xs font-bold text-white rounded-full ${
            ...
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 sm:px-3.5 sm:py-2 text-[11px] sm:text-sm font-semibold text-white bg-[#0b1b33] hover:bg-[#122849] rounded-lg shadow-sm transition-all group shrink-0"
            >
              <Lock className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-cyan-400 group-hover:rotate-12 transition-transform" />
              <span className="inline sm:inline">Portal</span>
              <ChevronRight className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-slate-400 group-hover:translate-x-0.5 transition-transform hidden xs:inline" />
            </button>
            ...
            <div className="flex items-center lg:hidden shrink-0">
              <button
                ...
                className="p-1.5 text-slate-600 hover:text-slate-900 rounded-lg hover:bg-slate-100 transition-colors focus:outline-none"

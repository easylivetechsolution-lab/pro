        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 sm:px-3.5 sm:py-2 text-xs sm:text-sm font-semibold text-white bg-[#0b1b33] hover:bg-[#122849] rounded-lg shadow-sm transition-all group shrink-0"
            >
              ...
              <ChevronRight className="w-3.5 h-3.5 text-slate-400 group-hover:translate-x-0.5 transition-transform hidden xs:inline" />
            </button>

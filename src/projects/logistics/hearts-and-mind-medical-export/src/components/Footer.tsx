        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 pb-6 border-b border-slate-800">
          ...
          <div className="lg:col-span-4">
            <div className="flex items-center gap-3 mb-4 cursor-pointer" onClick={scrollToTop}>
              <div className="w-10 h-10 bg-gradient-to-br from-[#0c4a6e] to-[#0284c7] rounded-xl flex items-center justify-center shadow-md">
                <svg viewBox="0 0 24 24" className="w-6 h-6 text-white fill-current">
                  ...
                  <path d="M10.5 6.5h3v3h3v3h-3v3h-3v-3h-3v-3h3v-3z" className="fill-white" />
                </svg>
              </div>
              ...
              <div>
                ...
                <div className="text-xs font-bold text-[#0284c7] tracking-wider leading-none mt-0.5">
                  MEDICAL EXPORT LLC
                </div>
              </div>
            </div>
